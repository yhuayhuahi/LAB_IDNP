...
android {
    namespace = "com.example.batterymonitor_compose"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.batterymonitor_compose"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.material3:material3")     // Material 3 (Text, Scaffold, etc.)
